---
title: "Advanced Wrangling - Join and Bindings"
output:
  html_document:
    toc: true
    toc_float: true
...
<div class="progress">
  <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 56%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
</div>
