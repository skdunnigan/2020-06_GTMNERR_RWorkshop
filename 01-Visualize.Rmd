---
title: "Session 1 - Visualize Data"
output:
  html_document:
    toc: true
    toc_float: true
...
<div class="progress">
  <div class="progress-bar progress-bar-striped" role="progressbar" style="width: 28%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
</div>
...
Data visualization is the first step in data exploration and is also a great place to start off when learning `R` because it has a clear payoff - "*I want to make a plot, and I did it!*! We will be using the `ggplot2` package. This is one of the earliest packages in the `tidyverse` and it implements the "grammar of graphics", which is a logical system for describing and building graphs.
